...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_checkpoint_path', type=str, default='./log_s3dis_2/log_proto_s3dis_S0_N2_K1_TL0_Att1',
    ...
    args.edgeconv_widths = ast.literal_eval(args.edgeconv_widths) # ast.literal_eval: Type conversion of strings
    ...
    if args.phase=='mptitrain':
        ...
        train(args)
    elif args.phase=='2CBReval' or args.phase=='mptieval':
